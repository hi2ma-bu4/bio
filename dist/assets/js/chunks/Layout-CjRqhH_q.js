...
import 'piccolore';
import { c as $$ThemeToggle, d as $$NavLinks, e as $$Logo, f as SITE_URL, B as BASE_DIR, A as AUTHOR, S as SITE_TITLE, a as SITE_DESCRIPTION, $ as $$Footer, b as $$Header, G as GTAG_ID } from './Header-71fqZZ_w.js';
/* empty css               */
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="ja" prefix="og: https://ogp.me/ns#" data-overlayscrollbars-initialize> <head prefix="website: https://ogp.me/ns/website#">', '<script type="application/ld+json">', "<\/script>", "", "", "", '<link rel="dns-prefetch" href="//www.googletagmanager.com"><script async', "><\/script>", '<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@400;700&family=Noto+Sans+JP:wght@400;700&display=swap">', '</head> <body class="min-h-screen flex flex-col w-full" data-overlayscrollbars-initialize> <!-- Google Tag Manager (noscript) --> <noscript><iframe', ' height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> <!-- End Google Tag Manager (noscript) --> ', " ", ' <div id="bg-canvas"', '></div> <main class="grow w-full max-w-5xl mx-auto px-4 py-8 md:px-8" role="main"> ', " </main> ", " ", " ", " ", " ", " ", " </body> </html>"])), renderComponent($$result, "SEO", $$SEO, { "charset": "UTF-8", "title": title, "titleDefault": "Page", "titleTemplate": `%s | ${SITE_TITLE}`, "description": description, "openGraph": {
    basic: {
      title,
      type: "website",
