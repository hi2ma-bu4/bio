import { a as createComponent, eh as maybeRenderHead, ei as addAttribute, ej as renderComponent, er as createTransitionScope, es as $$Sun, et as $$Moon, ek as renderTemplate, c as createAstro, en as renderScript, eu as $$Bars3, eo as defineScriptVars, ev as renderSlot, ew as renderHead, ex as $$GoogleFontsOptimizer, ey as $$ClientRouter, ez as $$SEO } from './vendor-D-u0yaMU.js';
import 'piccolore';
/* empty css                        */
import 'clsx';
...
const $$ThemeToggle = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<button class="theme-toggle p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" aria-label="テーマを切り替える"${addAttribute(createTransitionScope($$result, "wppfukqh"), "data-astro-transition-persist")}> ${renderComponent($$result, "SunIcon", $$Sun, { "class": "w-6 h-6 text-slate-800 dark:hidden" })} ${renderComponent($$result, "MoonIcon", $$Moon, { "name": "moon", "class": "w-6 h-6 text-slate-200 hidden dark:block" })} </button>`;
...
export { $$Layout as $, BASE_DIR as B, CLASS_AUTO_IMG_ALT as C };
