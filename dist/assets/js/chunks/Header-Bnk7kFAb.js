import { a as createComponent, m as maybeRenderHead, r as renderTemplate, c as createAstro, f as addAttribute, s as spreadAttributes, ez as createTransitionScope, d as renderComponent, eC as $$Sun, eD as $$Moon } from './vendor-zsY7UJHi.js';
import 'piccolore';
import 'clsx';
...
const $$NavLinks = createComponent(($$result, $$props, $$slots) => {
  ...
  const { class: className, itemClass } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<ul${addAttribute(className, "class")}> ${NAV_LINKS.map((link) => renderTemplate`<li> <a${addAttribute(link.href, "href")}${addAttribute([itemClass, { "font-bold text-primary-600 dark:text-primary-400": Astro2.url.pathname === link.href }], "class:list")}${addAttribute(Astro2.url.pathname === link.href ? "page" : false, "aria-current")}> ${link.text} </a> </li>`)} </ul>`;
}, "C:/Users/snows/Documents/Program/js/bio/src/components/NavLinks.astro", void 0);
...
export { $$Footer as $, AUTHOR as A, BASE_DIR as B, CLASS_AUTO_IMG_ALT as C, GTAG_ID as G, SITE_TITLE as S, __vite_glob_0_1 as _, SITE_DESCRIPTION as a, $$Header as b, $$ThemeToggle as c, $$NavLinks as d, $$Logo as e };
//# sourceMappingURL=Header-Bnk7kFAb.js.map
