...
var Er = N(() => {
  ...
  yr = (n, t) => {
    ...
    if (u != null) {
      ...
      for (let _ = 0; _ < d; _++) for (let z = 0; z < o; z++) {
        let v = (n.data[b++] - h[0]) * m[0], O = (n.data[y++] - h[1]) * m[1], F = (n.data[T++] - h[2]) * m[2], P = I === -1 ? 255 : (n.data[I++] - h[3]) * m[3];
        u.fillStyle = "rgba(" + v + "," + O + "," + F + "," + P + ")", u.fillRect(z, _, 1, 1);
      }
    ...
    if (a != null) {
      ...
      let y = 4, T = 0, I = 1, _ = 2, z = 3, v = 0, O = b, F = b * 2, P = -1;
      l === "RGBA" ? (v = 0, O = b, F = b * 2, P = b * 3) : l === "RGB" ? (v = 0, O = b, F = b * 2) : l === "RBG" && (v = 0, F = b, O = b * 2), u = a.createImageData(o, d);
      for (let k = 0; k < d * o; T += y, I += y, _ += y, z += y, k++) u.data[T] = (n.data[v++] - g[0]) * h[0], u.data[I] = (n.data[O++] - g[1]) * h[1], u.data[_] = (n.data[F++] - g[2]) * h[2], u.data[z] = P === -1 ? 255 : (n.data[P++] - g[3]) * h[3];
    } else throw new Error("Can not access image data");
    return u;
  };
});
...
var Ir = N(() => {
  ...
  Kt = (n, t) => {
    ...
    let l = t.format !== void 0 ? t.format : "RGBA", m = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : "RGB", h = a * u, g = m === "RGBA" ? new Float32Array(h * 4) : new Float32Array(h * 3), b = 4, y = 0, T = 1, I = 2, _ = 3, z = 0, v = h, O = h * 2, F = -1;
    l === "RGB" && (b = 3, y = 0, T = 1, I = 2, _ = -1), m === "RGBA" ? F = h * 3 : m === "RBG" ? (z = 0, O = h, v = h * 2) : m === "BGR" && (O = 0, v = h, z = h * 2);
    for (let k = 0; k < h; k++, y += b, I += b, T += b, _ += b) g[z++] = (n[y] + c[0]) / d[0], g[v++] = (n[T] + c[1]) / d[1], g[O++] = (n[I] + c[2]) / d[2], F !== -1 && _ !== -1 && (g[F++] = (n[_] + c[3]) / d[3]);
...
var nn = {};
it(nn, { InferenceSession: () => ts, TRACE: () => xr, TRACE_EVENT_BEGIN: () => _e, TRACE_EVENT_END: () => Ue, TRACE_FUNC_BEGIN: () => Pe, TRACE_FUNC_END: () => De, Tensor: () => de, env: () => Y, registerBackend: () => Je });
var Te = N(() => {
  "use strict";
  pr();
  br();
...
async function Vr(n = {}) {
  ...
  t.mountExternalData = (e, r) => {
    ...
    delete t.Rb;
  }, globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({ initial: 0, maximum: 0, jc: true }).buffer.constructor;
  var d, c, l = (e, r) => {
    throw r;
  }, m = import.meta.url, h = "";
  if (a || u) {
  ...
  var g, b, y, T, I, _, z = console.log.bind(console), v = console.error.bind(console), O = z, F = v, P = false, k = (e) => e.startsWith("file://");
  function w() {
    ...
    let e = function(r) {
      try {
        ...
        if (s === "load") {
          ...
          ge = i.dc, ee(), b = i.ec, Ut(), st();
        } else if (s === "run") {
          (function(f) {
            var p = (w(), W)[f + 52 >>> 2 >>> 0];
            f = (w(), W)[f + 56 >>> 2 >>> 0], sr(p, p - f), D(p);
          })(i.Ob), zt(i.Ob, 0, 0, 1, 0, 0), wn(), Ft(i.Ob), Z ||= true;
          try {
            Ao(i.bc, i.Tb);
          } catch (f) {
            if (f != "unwind") throw f;
          }
        } else i.target !== "setimmediate" && (s === "checkMailbox" ? Z && nt() : s && (F(`worker: received unknown command ${s}`), F(i)));
      } catch (f) {
        throw tr(), f;
      }
    };
  ...
  function q() {
    return { a: { R: fa, f: Io, w: Bo, e: Lo, k: Po, g: Do, S: _o, b: Uo, F: xo, ta: vn, j: Mo, K: In, Ja: Bn, pa: Ln, ra: Pn, Ka: Dn, Ha: _n, Aa: Un, Ga: xn, Y: Mn, qa: Cn, na: Rn, Ia: Fn, oa: Nn, Pa: Co, Da: Ro, la: No, ua: ko, ia: Wo, T: Go, Ca: Ft, Ma: $o, xa: zo, ya: Ho, za: jo, va: $n, wa: zn, ja: Hn, Ra: Yo, Oa: Xo, V: Qo, U: Zo, Na: Jo, E: Ko, La: ea, ma: ta, u: Vo, G: na, Q: ot, ka: oa, aa: ra, Sa: aa, Ea: Yn, Fa: Jn, sa: ye, H: qn, X: Xn, Ba: Qn, W: Zn, _: ja, L: Wa, $: Ha, M: ka, v: Pa, d: pa, m: la, n: ca, r: va, ba: Ra, x: Ia, o: wa, N: Fa, C: Ga, I: Ca, ca: Ma, da: xa, P: Da, O: Ua, ea: _a, z: Ba, D: Na, c: da, q: ha, i: ma, Z: Va, l: ya, p: ga, s: ba, t: Ea, y: Oa, fa: La, A: $a, J: Aa, B: za, ga: Sa, ha: Ta, h: ia, a: ge, Qa: V } };
  }
  async function Ut() {
    function e(s, f) {
      ...
      })(), mn.push(Ee.vb), s = Ee, t._OrtInit = s.Ua, t._OrtGetLastError = s.Va, t._OrtCreateSessionOptions = s.Wa, t._OrtAppendExecutionProvider = s.Xa, t._OrtAddFreeDimensionOverride = s.Ya, t._OrtAddSessionConfigEntry = s.Za, t._OrtReleaseSessionOptions = s._a, t._OrtCreateSession = s.$a, t._OrtReleaseSession = s.ab, t._OrtGetInputOutputCount = s.bb, t._OrtGetInputOutputMetadata = s.cb, t._OrtFree = s.db, t._OrtCreateTensor = s.eb, t._OrtGetTensorData = s.fb, t._OrtReleaseTensor = s.gb, t._OrtCreateRunOptions = s.hb, t._OrtAddRunConfigEntry = s.ib, t._OrtReleaseRunOptions = s.jb, t._OrtCreateBinding = s.kb, t._OrtBindInput = s.lb, t._OrtBindOutput = s.mb, t._OrtClearBoundOutputs = s.nb, t._OrtReleaseBinding = s.ob, t._OrtRunWithBinding = s.pb, t._OrtRun = s.qb, t._OrtEndProfiling = s.rb, at = s.sb, Kn = t._free = s.tb, er = t._malloc = s.ub, zt = s.xb, tr = s.yb, nr = s.zb, rr = s.Ab, Ht = s.Bb, or = s.Cb, ar = s.Db, M = s.Eb, Ye = s.Fb, sr = s.Gb, D = s.Hb, jt = s.Ib, U = s.Jb, ir = s.Kb, Vt = s.Lb, ur = s.Mb, fr = s.Nb, cr = s.wb, b = f, Ee;
    }
    var r, i = q();
  ...
  var ye = (e) => {
    ...
    var r = e.Ob;
    delete Oe[r], ce.push(e), Fe.splice(Fe.indexOf(e), 1), e.Ob = 0, rr(r);
  };
  function wn() {
    mn.forEach((e) => e());
  }
  var bn = (e) => new Promise((r) => {
    e.onmessage = (f) => {
      var p = f.data;
      if (f = p.Pb, p.Sb && p.Sb != at()) {
        var E = Oe[p.Sb];
        E ? E.postMessage(p, p.Xb) : F(`Internal error! Worker sent a message "${f}" to target pthread ${p.Sb}, but that thread no longer exists!`);
      } else f === "checkMailbox" ? nt() : f === "spawnThread" ? ue(p) : f === "cleanupThread" ? Rt(() => {
        hn(Oe[p.cc]);
      }) : f === "loaded" ? (e.loaded = true, r(e)) : p.target === "setimmediate" ? e.postMessage(p) : f === "uncaughtException" ? e.onerror(p.error) : f === "callHandler" ? t[p.Yb](...p.args) : f && F(`worker sent an unknown command ${f}`);
    }, e.onerror = (f) => {
  ...
  function Io(e) {
    var r = new xt(e >>>= 0);
    return (w(), j)[r.Qb + 12 >>> 0] == 0 && (En(r, true), tt--), Tn(r, false), et.push(r), fr(e);
  }
  var Ne = 0, Bo = () => {
    M(0, 0);
    var e = et.pop();
  ...
  var Mt = (e) => {
    ...
    for (var f of e) {
      if (f === 0 || f === s) break;
      if (ur(f, s, i.Qb + 16)) return Ye(f), r;
    }
    return Ye(s), r;
  };
  function Lo() {
  ...
  var _o = () => {
    ...
    var r = e.Ub;
    throw (w(), j)[e.Qb + 13 >>> 0] == 0 && (et.push(e), Tn(e, true), En(e, false), tt++), Vt(r), Ne = r;
  };
  function Uo(e, r, i) {
    var s = new xt(e >>>= 0);
    throw r >>>= 0, i >>>= 0, (w(), W)[s.Qb + 16 >>> 2 >>> 0] = 0, (w(), W)[s.Qb + 4 >>> 2 >>> 0] = r, (w(), W)[s.Qb + 8 >>> 2 >>> 0] = i, Vt(e), tt++, Ne = e;
  }
  var xo = () => tt;
  function Sn(e, r, i, s) {
  ...
  function No(e, r) {
    (e >>>= 0) == r >>> 0 ? setTimeout(nt) : o ? postMessage({ Sb: e, Pb: "checkMailbox" }) : (e = Oe[e]) && e.postMessage({ Pb: "checkMailbox" });
  }
  var Nt = [];
...
`);
    return e[0] == "Error" && e.shift(), jn(e), Ie.Vb = rt(e[3]), Ie.$b = e, Ie.Vb;
  }
  function ot(e) {
    ...
    Kn(ot.Wb ?? 0), r = Wt(e) + 1;
    var i = er(r);
    return i && Ae(e, i, r), ot.Wb = i, ot.Wb;
  }
  function oa(e) {
    e >>>= 0;
    var r = (w(), ne).length;
...
`))[0] == "Error" && s.shift(), jn(s);
  ...
  })(), o || (ge = new WebAssembly.Memory({ initial: 256, maximum: 65536, shared: true }), ee()), t.wasmBinary && (g = t.wasmBinary), t.stackSave = () => U(), t.stackRestore = (e) => D(e), t.stackAlloc = (e) => jt(e), t.setValue = function(e, r, i = "i8") {
  ...
  var at, Kn, er, zt, tr, nr, rr, Ht, or, ar, M, Ye, sr, D, jt, U, ir, Vt, ur, fr, cr, Ee, ua = [V, fe, Sn, In, Bn, Ln, Pn, Dn, _n, Un, xn, Mn, Cn, Rn, Fn, Nn, $n, zn, Hn, Yn, Jn, qn, Xn, Qn, Zn], lr = { 916652: (e, r, i, s, f) => {
    if (t === void 0 || !t.Rb) return 1;
    if ((e = Ct(Number(e >>> 0))).startsWith("./") && (e = e.substring(2)), !(e = t.Rb.get(e))) return 2;
  ...
  }, 917476: () => typeof wasmOffsetConverter < "u" };
  function fa() {
  ...
  function Aa(e, r, i, s, f, p, E, S, x, R, X, le) {
    var we = U();
    try {
      C(e)(r, i, s, f, p, E, S, x, R, X, le);
    } catch (be) {
      if (D(we), be !== be + 0) throw be;
      M(1, 0);
    }
  }
  ...
  function Ga(e, r, i, s, f, p, E, S, x, R, X, le) {
    var we = U();
    try {
      return C(e)(r, i, s, f, p, E, S, x, R, X, le);
    } catch (be) {
      if (D(we), be !== be + 0) throw be;
      M(1, 0);
    }
  ...
  function $a(e, r, i, s, f, p, E, S, x, R, X) {
    var le = U();
    try {
      C(e)(r, i, s, f, p, E, S, x, R, X);
    } catch (we) {
      if (D(le), we !== we + 0) throw we;
      M(1, 0);
    }
  }
  function za(e, r, i, s, f, p, E, S, x, R, X, le, we, be, Ya, Ja) {
    var qa = U();
    try {
      C(e)(r, i, s, f, p, E, S, x, R, X, le, we, be, Ya, Ja);
    } catch (Yt) {
      if (D(qa), Yt !== Yt + 0) throw Yt;
      M(1, 0);
    }
  }
  function Ha(e, r, i) {
  ...
  function st() {
    if (0 < Re) te = st;
      ...
      0 < Re ? te = st : (t.calledRun = true, P || (he(), T?.(t)));
    }
  }
...
var xe = N(() => {
  ...
  un = false, Tt = false, no = false, fs = () => {
    ...
    if (t > 0 && I.push(new Promise((_) => {
      ...
      y(v).then((O) => {
        Tt = false, un = true, sn = O, _(), b && URL.revokeObjectURL(b);
      }, (O) => {
...
var rn = N(() => {
  ...
  ws = (n, t) => {
    ...
    try {
      if ([c, m] = await ao(t), t?.externalData && o.mountExternalData) {
        ...
        for (let k of t.externalData) {
          ...
          P.push(Ze(typeof k == "string" ? k : k.data).then((Z) => {
      ...
      for (let P of t?.executionProviders ?? []) if ((typeof P == "string" ? P : P.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof P != "string") {
          let w = P, Z = w?.context, j = w?.gpuDevice, ne = w?.deviceType, pe = w?.powerPreference;
      ...
      let [b, y] = bs(d), T = !!t?.enableGraphCapture, I = [], _ = [], z = [], v = [], O = [];
      for (let P = 0; P < b; P++) {
        let [k, w, Z] = co(d, P);
      ...
      for (let P = 0; P < y; P++) {
        ...
        let j = o.UTF8ToString(k);
        _.push(j), v.push(w === 0 ? { name: j, isTensor: false } : { name: j, isTensor: true, type: Ot(w), shape: Z });
      }
      return Ge.set(d, [d, h, g, null, T, false]), [d, I, _, z, v];
    } catch (b) {
    ...
    let _ = l.stackSave(), z = l.stackAlloc(4 * g.length);
    try {
    ...
    let h = m[0], g = m[1], b = m[2], y = m[3], T = m[4], I = m[5], _ = t.length, z = u.length, v = 0, O = [], F = [], P = [], k = [], w = [], Z = c.stackSave(), j = c.stackAlloc(_ * l), ne = c.stackAlloc(_ * l), pe = c.stackAlloc(z * l), B = c.stackAlloc(z * l);
    try {
      [v, O] = ro(d), _e("wasm prepareInputOutputTensor");
      for (let A = 0; A < _; A++) await lo(a[A], F, k, n, g[t[A]], t[A], T);
      for (let A = 0; A < z; A++) await lo(o[A], P, k, n, b[u[A]], _ + u[A], T);
      Ue("wasm prepareInputOutputTensor");
      for (let A = 0; A < _; A++) c.setValue(j + A * l, F[A], "*"), c.setValue(ne + A * l, g[t[A]], "*");
      for (let A = 0; A < z; A++) c.setValue(pe + A * l, P[A], "*"), c.setValue(B + A * l, b[u[A]], "*");
      c.jsepOnRunStart?.(h), c.webnnOnRunStart?.(h);
      let W;
      W = await c._OrtRun(h, ne, j, _, B, z, pe, v), W !== 0 && G("failed to call OrtRun().");
      let re = [], me = [];
      _e("wasm ProcessOutputTensor");
      for (let A = 0; A < z; A++) {
        let K = Number(c.getValue(pe + A * l, "*"));
        if (K === P[A] || w.includes(P[A])) {
          re.push(o[A]), K !== P[A] && c._OrtReleaseTensor(K) !== 0 && G("Can't release tensor.");
          continue;
        }
      ...
      c.webnnOnRunEnd?.(h), c.stackRestore(Z), F.forEach((W) => c._OrtReleaseTensor(W)), P.forEach((W) => c._OrtReleaseTensor(W)), k.forEach((W) => c._free(W)), v !== 0 && c._OrtReleaseRunOptions(v), O.forEach((W) => c._free(W));
    }
  }, gt = (n) => {
    let t = $(), a = Ge.get(n);
...
var vo = {};
it(vo, { OnnxruntimeWebAssemblyBackend: () => _t, initializeFlags: () => So, wasmBackend: () => Ts });
var So;
var _t;
var Ts;
var Oo = N(() => {
...
// src/workers/handwritten-classifier.worker.ts
var HandwrittenClassifier = class {
  session = null;
  labels = [];
  inputHeight = 64;
  inputWidth = 64;
  ...
  async recognize(imageData) {
    ...
    for (const segment of segments) {
      ...
      const probabilities = toProbabilities(output.data);
...
var classifier = new HandwrittenClassifier();
self.addEventListener("message", async (event) => {
  ...
  try {
    ...
    self.postMessage({
      type: "error",
      requestId: message.type === "recognize" ? message.requestId : void 0,
      message: error.message
    });
  }
});
function segmentIntoCharacters(imageData) {
...
function mergeBox(target, source) {
...
function computeOverlap(startA, endA, startB, endB) {
...
function cropCharacterRegion(source, left, top, right, bottom) {
...
function preprocessCharacter(imageData, inputWidth, inputHeight, channels, layout) {
...
function selectAllowedCandidates(probabilities, labels, limit) {
  const ranked = [];
...
function buildSequenceSuggestions(perCharacterCandidates, limit) {
...
onnxruntime-web/dist/ort.wasm.bundle.min.mjs:
   ...
   *)
*/
//# sourceMappingURL=handwritten-classifier.worker.js.map
