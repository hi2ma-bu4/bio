import { AUTHOR, BASE_DIR, GA4_TAG, GTAG_ID, SITE_DESCRIPTION, SITE_TITLE, SITE_URL } from "astro:env/client";

export { AUTHOR, BASE_DIR, GA4_TAG, GTAG_ID, SITE_DESCRIPTION, SITE_TITLE, SITE_URL };
