...
import imageKanjiSearch from "../imgs/kanjiSearch.png";
import imageMandelbrot from "../imgs/mandelbrot.png";
import imageMidiFallingBar from "../imgs/midiFallingBar.png";
import imageTool2048 from "../imgs/tool2048.png";

/** 作品データの一覧 */
export const worksData: WorkItemData[] = [
	{
		id: "RepoShowcase",
		title: "RepoShowcase",
...
/** 作品IDをキーとしたマップデータ */
export const workItemsMap = worksData.reduce(
	(acc, work) => {
		acc[work.id] = work;
		return acc;
	},
